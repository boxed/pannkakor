...
var _user$project$Main$prettyRound = function (f) {
	var r = A2(_myrho$elm_round$Round$round, 2, f);
	var parts = A2(_elm_lang$core$String$split, '.', r);
	var _p0 = parts;
	if (_p0.ctor === '[]') {
		return r;
	} else {
...
var _user$project$Main$ingredientView = F2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: _elm_lang$html$Html$text(
					_user$project$Main$prettyRound(model * ingredient.quantity)),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text(' '),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html$text(ingredient.unit),
						_1: {ctor: '[]'}
					}
				}
			});
...
var _user$project$Main$model = 3;
var _user$project$Main$Ingredient = F2(
	function (a, b) {
		return {quantity: a, unit: b};
	});
var _user$project$Main$ingredients = {
	ctor: '::',
	_0: A2(_user$project$Main$Ingredient, 2.5 / 3, 'dl vetemjöl'),
	_1: {
		ctor: '::',
		_0: A2(_user$project$Main$Ingredient, 0.5 / 3, 'tsk salt'),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Main$Ingredient, 6 / 3, 'dl mjölk'),
			_1: {
				ctor: '::',
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Pannkakor'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							A2(
								_elm_lang$core$List$map,
								_user$project$Main$ingredientView(model),
								_user$project$Main$ingredients)),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('mindre'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('MER'),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
